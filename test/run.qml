...
Item { width: 10; height: 10
  ...
  Timer { interval: 400; running: true; onTriggered: {
    ...
    svc.showWindow(); svc.setScene("Rest"); reopen.start() } }
  Timer { id: reopen; interval: 500; onTriggered: { svc.hideWindow(); svc.showWindow(); svc.win.visible = false; svc.showWindow() } }
  Timer { interval: 1500; running: true; onTriggered: { console.log("service ran; windowOpen after hide/show/force-hide/show:", svc.windowOpen, "showTries", svc.showTries, "plate", !!svc.plateMsg, "amps", svc.modeAmps.length); Qt.quit() } }
}
