...
Item {
  ...
  IpcHandler {
    ...
    function diag(): string { return JSON.stringify({ version: "0.6.6", panel: panelVisual.diag(), saverOpen: root.saverOpen, saver: root.saverDiag, tables: !!(root.tables && root.tables.scenes && root.tables.scenes.length) }) }
